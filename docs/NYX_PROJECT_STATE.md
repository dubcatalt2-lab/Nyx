...
- Link Checker full-scan retry asset version `20260808-full-scan-retry-v9` is live, and unauthenticated `/api/link-checker/full-scan/status` requests return HTTP 401
