...
- Latest application release: commit `51c884d` on `agent/pirate-cove`, deployed to OVH and production-verified on 2026-08-13. Nyx Chat now exposes 80 permission-aware slash commands, adds in-voice WebRTC screen sharing with responsive remote-share presentation and automatic cleanup, and preserves the refined edge-mounted rose profile treatment.
