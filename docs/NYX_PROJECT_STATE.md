...
- Latest application release: commit `d4b91b8` on `agent/pirate-cove`, deployed to OVH and production-verified on 2026-08-20. It preserves the app/browser/home release from `564c00a`, repairs Settings, account/profile controls, and embedded Chat profile handoff after escaped-ad quarantine, makes account switching non-destructive until replacement login succeeds, expands the responsive Fern constellation field, and replaces dark-on-black app marks with locally bundled color assets.
