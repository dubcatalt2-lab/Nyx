...
Last repository review: 2026-08-18
...
- Latest application release: commit `290a678` on `agent/pirate-cove`, deployed to OVH and production-verified on 2026-08-18. It retains the balanced minimalist homepage/theme system, live Performance dashboard metrics, refreshed Owner Dashboard and Chat presentation, account-action notices, protected profile-media resolution, corrected Chat navigation, server-authorized moderation commands, personal Nyx AI key/preferences handoff, and exact-name search metadata from the prior release.
