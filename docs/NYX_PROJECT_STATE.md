...
- Link Checker account-bridge asset version `20260808-account-bridge-v8` is live, and unauthenticated `/api/link-checker/full-scan/status` requests return HTTP 401
