...
- Link Checker cached-first asset version `20260808-cached-first-v10` is live, and unauthenticated `/api/link-checker/full-scan/status` requests return HTTP 401
