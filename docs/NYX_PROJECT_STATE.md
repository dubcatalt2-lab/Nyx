...
- Chat expands a bounded built-in set of recognized emoji shortcodes such as `:smiley:`, `:joy:`, `:skull:`, `:heart:`, and `:coffee:` on the actual send path. Unknown shortcodes remain unchanged.
