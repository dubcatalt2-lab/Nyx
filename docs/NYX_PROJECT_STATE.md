...
- Latest application release: commit `6a5c1f2` on `agent/pirate-cove`, deployed to OVH and production-verified on 2026-08-13. It suppresses profile effects and avatar decorations in the compact homepage account menu while retaining cosmetics on full profile surfaces and in the editor preview.
