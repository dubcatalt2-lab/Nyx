...
export function aiWantsWeb(message) {
  return /https?:\/\/|\b(search|browse|crawl|look\s*up|google|latest|current|today|news|sources?|websites?|webpages?|online)\b|\bfind\b.{0,100}\b(recipes?|sites?|links?|articles?|tutorials?|guides?)\b/i.test(String(message));
}
