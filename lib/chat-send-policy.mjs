...
export function chatSendDecision(previous={},text='',now=Date.now()) {
  ...
  if(repeated||burst||recent.length>=20)return {state:{recent,until:now+30000},error:(repeated?'Repeated messages were blocked.':'You are sending messages too quickly.')+' Please wait 30 seconds.',retryAfter:30};
