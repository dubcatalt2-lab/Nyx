...
export function createMediaConnector({ lookupImpl = lookup, connectImpl = tls.connect,
  ...
  return (options, callback) => {
    ...
    function start() {
      ...
      const socket = connectImpl({ host: address.address, family: address.family,
...
export function createMediaFetch() {
  const agent = new https.Agent({ keepAlive: true, maxSockets: 6, maxTotalSockets: 24, maxFreeSockets: 2, timeout: 30_000 });
