...
const requiredFiles = [
  ...
  "lib/movie-anime-sources.mjs",
  "lib/movie-public-api.mjs",
  ...
  "apps/movies/app.js",
  "apps/movies/providers.mjs",
  "apps/movies/proxy.mjs",
  ...
  "assets/partners/uncensor.png",
  "assets/partners/nocturne.png",
  "assets/partners/photon.png",
  "assets/partners/black-hat.png",
  "assets/partners/zaka.png",
  "assets/partners/milkbox.png",
  ...
  "deploy/render-caddy.mjs",
  "deploy/haproxy-turn.cfg.template",
  "deploy/refresh-turn-router.sh",
  "deploy/renew-turn-certificate.sh",
  ...
  "services/stratus/ice-config.mjs",
