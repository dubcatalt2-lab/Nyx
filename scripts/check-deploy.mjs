...
const requiredFiles = [
  ...
  "apps/tutsi/relay.mjs",
  "apps/tutsi/filter-detection.mjs",
  "js/duck-image-viewport.js",
  "apps/tutsi/proxy-compat.mjs",
  "apps/tutsi/icons.mjs",
  "apps/tutsi/clock.mjs",
  "apps/tutsi/profiles.html",
  "apps/tutsi/profiles.css",
  "apps/tutsi/embedded.mjs",
  "apps/tutsi/embedded.css",
  "apps/tutsi/font.css",
  "apps/tutsi/fonts/homemade-apple.ttf",
  "apps/tutsi/fonts/indie-flower.ttf",
  "apps/tutsi/fonts/Indie-Flower-OFL.txt",
  "apps/tutsi/fonts/LICENSE.txt",
  "apps/tutsi/icon.png",
