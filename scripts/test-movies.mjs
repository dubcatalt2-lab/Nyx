...
try{
 ...
 await page.locator('#choose-source').click();await page.locator('[data-provider=videasy]').click();
 ...
 await page.locator('#choose-source').click();await page.locator('[data-provider=vidfast]').click();
 ...
 await page.locator('#choose-source').click();await page.locator('[data-provider=embed-su]').click();
