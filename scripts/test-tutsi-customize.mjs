...
try{
 ...
 await page.locator('[data-customize-step="0"] button[data-value=latte]').click();await page.locator('#customize-next').click();await page.locator('[data-customize-step="1"] button[data-value=peach]').click();
 ...
 await page.locator('#customize-next').click();await page.locator('[data-customize-step="5"] button[data-value=goguardian]').click();await page.locator('#customize-next').click();await wizard.waitFor({state:'hidden'});assert.equal(await page.title(),'My notebook');assert.equal(await page.locator('#blocker').inputValue(),'goguardian');
 ...
 await page.locator('[data-customize-step="0"] button[data-value=mocha]').click();await page.keyboard.press('Escape');assert.equal(await page.locator('html').getAttribute('data-theme'),'latte');
